...
st.dataframe(
    df[[
        ...
        "prix_moyen", "prix_moyen_corrige", "ecart_type", "ecart_type_corrige",
        "prix_min", "prix_max",
    ]],
    ...
    column_config={
        ...
        "ecart_type": st.column_config.NumberColumn("Écart-type brut", format="%.2f"),
        "ecart_type_corrige": st.column_config.NumberColumn("Écart-type corrigé", format="%.2f"),
